...
class FamilyPaymentsRepositoryImpl implements FamilyPaymentsRepository {
  ...
  Future<Result<List<FamilyPaymentCard>>> listCards() => _guard(
    () async =>
        (await _remote.listCards()).map((dto) => dto.toDomain()).toList(),
  );
  ...
  Future<Result<FamilyPaymentCard>> verifyCard(String cardId) =>
      _guard(() async => (await _remote.verifyCard(cardId)).toDomain());
  ...
  Future<Result<FamilyPaymentCard>> unfreezeCard(String cardId) =>
      _guard(() async => (await _remote.unfreezeCard(cardId)).toDomain());

  @override
  Future<Result<KidPaymentSource>> kidPaymentSource(String kidId) =>
      _guard(() async => (await _remote.kidPaymentSource(kidId)).toDomain());
  ...
  Future<Result<KidSpendingLimits>> kidLimits(String kidId) =>
      _guard(() async => (await _remote.kidLimits(kidId)).toDomain());
  ...
  Future<Result<KidMerchantRules>> kidMerchantRules(String kidId) =>
      _guard(() async => (await _remote.kidMerchantRules(kidId)).toDomain());
  ...
  Future<Result<KidScheduleRules>> kidSchedule(String kidId) =>
      _guard(() async => (await _remote.kidSchedule(kidId)).toDomain());
  ...
  Future<Result<KidAutoPaymentRules>> kidAutoPayment(String kidId) =>
      _guard(() async => (await _remote.kidAutoPayment(kidId)).toDomain());
  ...
  Future<Result<KidApprovalRules>> kidApprovalRules(String kidId) =>
      _guard(() async => (await _remote.kidApprovalRules(kidId)).toDomain());
  ...
  Future<Result<KidGeofenceRules>> kidGeofence(String kidId) =>
      _guard(() async => (await _remote.kidGeofence(kidId)).toDomain());
  ...
  @override
  Future<Result<FamilyPaymentDetail>> paymentDetail(String paymentId) => _guard(
  ...
  Future<Result<void>> approvePayment(String paymentId) =>
      _guard(() async => _remote.approvePayment(paymentId));

  @override
  Future<Result<void>> rejectPayment(String paymentId, {String? reason}) =>
      _guard(() async => _remote.rejectPayment(paymentId, reason: reason));
