...
/// SHA-256 pequeño para fingerprints locales; no maneja secretos backend.
String sha256Hex(String input) {
  ...
  for (var offset = 0; offset < paddedLength; offset += 64) {
    ...
    for (var index = 16; index < 64; index++) {
      final x = schedule[index - 15];
      final y = schedule[index - 2];
    ...
    for (var index = 0; index < 64; index++) {
      ...
      final temp1 =
          (h + sum1 + choose + _constants[index] + schedule[index]) &
          0xffffffff;
