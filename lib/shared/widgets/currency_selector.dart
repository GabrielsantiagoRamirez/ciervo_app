...
class _CurrencySelectorState extends State<CurrencySelector> {
  ...
  Widget build(BuildContext context) {
    ...
    final selected = _currencies.contains(widget.value)
        ? widget.value
        : suggested;
    ...
    return DropdownButtonFormField<String>(
      ...
      items: _currencies
          .map(
            (code) => DropdownMenuItem(value: code, child: Text(_label(code))),
          )
          .toList(),
      onChanged: _loading
          ? null
...
const kSupportedCurrencies = ['COP', 'CLP', 'MXN', 'PEN', 'ARS', 'USD'];
